...
This repository contains a comprehensive Exploratory Data Analysis (EDA) of employee salary data. The project uses Python to uncover key insights into how factors like department, education level, and experience correlate with monthly compensation.

##  Key Features
* **Data Inspection**: Initial loading and automated dataset verification using `pandas`.
* **Statistical Visualizations**: Detailed analysis of salary trends using `matplotlib` and `seaborn`.
* **Actionable Insights**: Identification of top-paying departments and the impact of higher education on pay scales.

##  Data Visualizations
The analysis produces the following key charts to interpret the dataset:
...
##  Project Structure
* `Eda_data_visualization.ipynb`: The main Jupyter Notebook containing all analysis and plotting code.
* `employee_salary_dataset.csv`: The source dataset (ensure this is in your local path).
